<?php get_header(); while(have_posts()) { the_post(); pageBanner(); ?>
  <div class="container container--narrow page-section">
    ...
    <?php $relatedSingers = new WP_Query(array(
      'posts_per_page' => -1,
      'post_type' => 'singers',
      'orderby' => 'title',
      'order' => 'ASC',
    ...
    if ($relatedSingers->have_posts()) {
      echo '<hr class="section-break">';
      echo '<h2 class="headline headline--medium">' . get_the_title() . ' Singers</h2>';
      echo '<ul class="professor-cards">';
    while($relatedSingers->have_posts()) {$relatedSingers->the_post(); ?>
      <li class="professor-card__list-item"> <a class="professor-card" href="<?php the_permalink(); ?>">
      <img class="professor-card__image" src="<?php the_post_thumbnail_url('singerLandscape'); ?>">
      <span class="professor-card__name"><?php the_title(); ?></span></a> </li>
    <?php } echo '</ul>'; }
      wp_reset_postdata();
      $today = date('Ymd');
