    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            <li <?php if(is_page('about-me') or wp_get_post_parent_id(0) == 17) echo 'class="current-menu-item"' ?>>
            ...
            <li <?php if (get_post_type() == 'festival') echo 'class="current-menu-item"' ?>>
              <a href="<?php echo get_post_type_archive_link('festival'); ?>">Festival</a></li>
